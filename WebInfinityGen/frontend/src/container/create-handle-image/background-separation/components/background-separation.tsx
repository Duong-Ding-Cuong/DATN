...
import { useBackgroundSeparation } from "../hooks/use-background-separation";
import styled from "styled-components";

export const BackgroundSeparationComponent = () => {
    const {
        imageData,
        isProcessing,
        error,
    ...
    return (
        <MyLayout>
            <RootContainer>
                <WelcomeContainer>
                    <WelcomeTitle>Xóa nền hình ảnh</WelcomeTitle>
                </WelcomeContainer>
